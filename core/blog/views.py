...
class PostDetailView(DetailView, FormMixin):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.success(
                self.request,
                "Comment submitted successfully and will be published after admin confirmation",
            )
...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "Post created Successfully and will be published after admin confirmation",
        )
...
class PostUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "Post updated successfully and will be published after admin confirmation",
        )
        return super().form_valid(form)
